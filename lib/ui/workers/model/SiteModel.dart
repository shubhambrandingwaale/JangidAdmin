...
class SiteModel {
  ...
  factory SiteModel.fromJson(Map<String, dynamic> json) => SiteModel(
    ...
    data: List<SiteDataList>.from(json["data"].map((x) => SiteDataList.fromJson(x))),
  );
...
class SiteDataList {
  ...
  factory SiteDataList.fromJson(Map<String, dynamic> json) => SiteDataList(
    id: json["id"]??0,
